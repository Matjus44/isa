...
class Utils
{
    public:
        ...
        void get_rdata_string(std::string name,uint16_t a_lenght,uint32_t a_ttl,uint16_t a_class,uint16_t a_type,const u_char *rdata_ptr, const u_char *frame, Utils utility_functions);
