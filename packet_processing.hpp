...
class PacketProcessing
{
    public:
        ...
        static const u_char * print_other_sections(const u_char *authority_pointer, Utils utility_functions, const u_char *question_pointer,  uint16_t count, std::string section_type);
};
