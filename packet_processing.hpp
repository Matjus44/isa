...
class PacketProcessing
{
    public:
        ...
        static void  print_sections(const u_char *pointer, Utils utility_functions, uint16_t an_count, const u_char *frame, uint16_t ns_count, uint16_t ar_count);
        static void print_authority_section(const u_char *authority_pointer, Utils utility_functions, const u_char *question_pointer, uint16_t ns_count, uint16_t ar_count);
